...
public class Cadastro_Pessoa_Professor extends CadastroAcademico.Classes.Pessoa_Professor implements Interface_Pessoa{

    public Cadastro_Pessoa_Professor() {
    }

    public Cadastro_Pessoa_Professor(String materia, String nome, String cpf, String matricula, int ano, int mes, int dia) {
    ...
    public void Cadastra(int mat) {
        ...
        try{
            ...
            /*Matrícula*/
            String matricula = "RP" + LocalDate.now().getYear()+LocalDate.now().getMonthValue() + "-0" + mat;
